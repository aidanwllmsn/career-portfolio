        ...
        <Grid size={{ xs: 12, md: 8 }}>
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <DockDemo />
              <div className="md:hidden md:order-2 items-center space-x-3 font-medium text-l rtl:space-x-reverse border border-[#27272a] p-3.5 mx-4 rounded-lg hover:bg-buttonhover">
                <DownloadIcon />
                <a
                  href="resume.pdf"
